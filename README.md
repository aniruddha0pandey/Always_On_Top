...
Now we're all set to dowload the *AutoIt Installer*. You can use the below mention commands. Refere [Screenshot](https://github.com/aniruddha0pandey/Always_On_Top/blob/master/README.md#screenshots)
```powershell
...
Then next step is to install the setup. Refere [Screenshot](https://github.com/aniruddha0pandey/Always_On_Top/blob/master/README.md#screenshots)
```powershell
> cd .\Downloads\
> autoit-v3-setup.exe
```
